...
export const metadata: Metadata = {
  title: "Mahmud Efendi Hazretleri (k.s)",
...
export default function MahmudEfendiPage() {
  return (
    <MaxWidthWrapper>
      <HeaderSection
        title="Mahmud Efendi Hazretleri (k.s)"
        description="Şeyhimiz Mahmud Efendi Hazretlerinin (k.s) hayatı, öğretileri ve İslam dünyasına katkıları hakkında bilgi edinin."
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex justify-center mb-12">
          <div className="relative w-full max-w-md h-[600px] rounded-lg overflow-hidden shadow-xl">
            <Image
              ...
              alt="Mahmud Efendi Hazretleri (k.s)"
              fill
        ...
        <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-6">
          ...
          <p>
            <em>Ve daha birçok büyük âlim Mahmud Efendi Hazretleri'nin yüce makamını tasdik etmiş, kendisine intisab etmiş ve hürmetlerini arz etmişlerdir.</em>
          </p>
        </div>
      </div>
    </MaxWidthWrapper>
